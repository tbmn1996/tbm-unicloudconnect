...
* **MCP-Sicherheit**: Die optionale MCP-Schnittstelle muss vom Anwender explizit freigegeben werden. Der Zugriff von KI-Agenten erfolgt rein lokal und nur, wenn die App aktiv läuft.
